<template>
  <nav
    :class="{ 'bg-slate-600 text-white': darkMode, 'text-black': !darkMode }"
  >
    <button
      ...
      class="p-2 rounded absolute sm:left-8 sm:top-6 left-4 top-6"
    >
      <svg
        v-if="darkMode"
        width="30px"
      ...
      >
        <path
          style="fill: #e5e5e5"
          d="M317.217,256c0-90.635,49.245-169.762,122.435-212.103C403.634,23.061,361.82,11.13,317.217,11.13
	...
	C366.463,425.762,317.217,346.635,317.217,256z"
        ...
        <path
          d="M445.226,458.468C373.132,416.764,328.348,339.181,328.348,256S373.132,95.238,445.226,53.532
	...
	s12.211,90.624,35.314,129.814c19.079,32.363,45.129,60.205,76.016,81.406C386.266,481.997,351.986,489.739,317.217,489.739z"
        />
        <path
          d="M196.852,111.304c2.459,0,4.935-0.811,6.994-2.479c33.507-27.112,75.745-42.043,118.936-42.043
	...
	c-4.779,3.867-5.518,10.876-1.651,15.654C190.393,109.893,193.608,111.304,196.852,111.304z"
        />
        <path
          d="M173.454,133.544c3.032,0,6.053-1.23,8.252-3.646c0.058-0.065,0.174-0.194,0.23-0.259c4.029-4.643,3.533-11.672-1.11-15.702
	...
	C168.112,132.592,170.786,133.544,173.454,133.544z"
        />
        <path
          d="M180.313,256c0-18.412-14.979-33.391-33.391-33.391S113.53,237.588,113.53,256s14.979,33.391,33.391,33.391
	...
	s11.13,4.993,11.13,11.13C158.052,262.137,153.059,267.13,146.922,267.13z"
        />
        <path
          d="M202.574,311.838c-24.447,0-44.336,19.889-44.336,44.336c0,24.447,19.889,44.336,44.336,44.336s44.336-19.889,44.336-44.336
    ...
    <router-link
      to="/"
      :class="{ 'text-slate-200': darkMode, 'text-black': !darkMode }"
